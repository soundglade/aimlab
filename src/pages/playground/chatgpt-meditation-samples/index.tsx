  ...
  return (
    <PlaygroundLayout>
      <div className="space-y-6">
        <div>
          <h1 className="mb-4 text-2xl">ChatGPT Meditation Samples</h1>
          <div className="mb-6 text-muted-foreground space-y-2">
            <p>
        ...
        <div className="space-y-4">
          <input
            ...
            className="w-full px-4 py-2 border rounded-md border-border bg-background"
          />
